...
<script src="{{asset('user8/vendor/datatables/jquery.dataTables.min.js')}}"></script>
<script src="{{asset('user8/vendor/datatables/dataTables.bootstrap4.min.js')}}"></script>

<!-- Page level custom scripts -->

<script src="{{asset('user8/js/demo/datatables-demo.js')}}"></script>
